...
## Project Structure
    ...
    ├── testapiautodatamod_108333  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_108333`
...
2. Clone this repo and `cd testapiautodatamod_108333`
